      ...
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className="hidden w-full md:flex md:items-center md:w-auto" id="mobile-menu">
          <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
            ...
            <li>
              <Link to="/dashboard/blog/create" className="flex items-center text-gray-300 hover:text-white">
                <i className="fas fa-plus-circle mr-2"></i> Create Blog
              </Link>
            </li>
            <li>
              <Link to="/dashboard/subscriptions" className="flex items-center text-gray-300 hover:text-white">
                <i className="fas fa-credit-card mr-2"></i> Subscriptions
              </Link>
            </li>
            <li>
              <Link to="/dashboard/transactions" className="flex items-center text-gray-300 hover:text-white">
                <i className="fas fa-history mr-2"></i> Transaction History
              </Link>
            </li>
            <li>
              <Link to="/dashboard/settings" className="flex items-center text-gray-300 hover:text-white">
