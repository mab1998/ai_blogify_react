      ...
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className="hidden w-full md:flex md:items-center md:w-auto" id="mobile-menu">
          <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
            ...
            <li>
                <Link to="/admin/manage_subscription" className="flex items-center text-gray-300 hover:text-white">
                <i className="fas fa-plus-circle mr-2"></i> Manage Subscription
              </Link>
            </li>
            <li>
              <Link to="/admin/manage_styles" className="flex items-center text-gray-300 hover:text-white">
                <i className="fas fa-credit-card mr-2"></i> Manage Styles
              </Link>
            </li>
            <li>
              <Link to="/admin/transactions" className="flex items-center text-gray-300 hover:text-white">
            ...
            <li>
              <Link to="/admin/users" className="flex items-center text-gray-300 hover:text-white">
                <i className="fas fa-user mr-2"></i> Manage Users
              </Link>
            </li>
            <li>
              <Link to="/admin/settings" className="flex items-center text-gray-300 hover:text-white">
