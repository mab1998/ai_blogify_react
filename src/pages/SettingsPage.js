        ...
        <div className="bg-white dark:bg-slate-800 shadow rounded-md p-4">
          <div className="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700 mb-4">
            <ul className="flex flex-wrap -mb-px">
              <li className="mr-2">
                <button onClick={() => setActiveTab('basic-information')} className={`inline-block p-4 rounded-t-lg border-b-2 ${activeTab === 'basic-information' ? 'border-blue-600 text-blue-600 dark:border-blue-500 dark:text-blue-500' : 'border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'}`}>
                  Basic Information
                </button>
              </li>
              <li className="mr-2">
          ...
          <div className="tab-content">
            {activeTab === 'basic-information' && (
              <div id="basic-information" className="tab-pane active-tab-content">
                <div className="card-body">
                  <form id="basic-info-form" className="form" onSubmit={handleSubmit}>
                    <div className="mb-4">
                      ...
                      <input name="name" className="form-control mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-700 dark:border-slate-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" id="name" placeholder="Enter Name" value={settings.name} onChange={handleChange} />
                    </div>
                    <div className="mb-4">
                      <label htmlFor="email" className="block text-sm font-medium text-gray-700 dark:text-gray-400">Email</label>
                      <input name="email" className="form-control mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-700 dark:border-slate-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="email" id="email" placeholder="Enter Email" value={settings.email} onChange={handleChange} />
                    </div>
                    <div className="mb-4">
                      <label htmlFor="current_password" className="block text-sm font-medium text-gray-700 dark:text-gray-400">Current Password</label>
                      <input name="current_password" className="form-control mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-700 dark:border-slate-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="password" id="current_password" placeholder="Enter Current Password" value={settings.current_password} onChange={handleChange} />
                    </div>
                    <div className="mb-4">
                      <label htmlFor="new_password" className="block text-sm font-medium text-gray-700 dark:text-gray-400">New Password</label>
                      <input name="new_password" className="form-control mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-700 dark:border-slate-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="password" id="new_password" placeholder="Enter New Password" value={settings.new_password} onChange={handleChange} />
                    </div>
